  ...
  <div class="components-page-header-demo-content">
    ...
    >
      ...
      >
        <a-row justify="center" style="margin-top: 20px; margin-bottom: 20px">
          <a-col :span="12">
            <div class="menu-item-card" @click="stockConsolidation">
              <div class="menu-item-icon-wrapper">
                <SwapOutlined class="menu-item-icon" />
              </div>
              <div class="menu-item-text">进入库存整理</div>
            </div>
          </a-col>
        </a-row>
      </a-tab-pane>
...
// 进入WMS内部库存整理页面，不再跳转外置服务。
function stockConsolidation() {
  router.replace('/stockConsolidation');
}
