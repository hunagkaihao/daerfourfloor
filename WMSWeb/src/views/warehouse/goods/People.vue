<template>
  ...
  >
    ...
    <a-table  :dataSource="dataSource"  :columns="columns3" :pagination="pagination" @change="handleTableChange" >
...
<script lang="ts" setup>
  ...
  import {  columns3,autoAllocateStockDetailWithTotal } from './Acceptance';
...
const handleTableChange = (pag, filters, sorter) => {
    ...
    const getdata = async()=>{
        ...
        await autoAllocateStockDetailWithTotal(params).then((res)=>{
